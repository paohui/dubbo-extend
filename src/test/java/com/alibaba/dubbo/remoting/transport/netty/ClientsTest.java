...
import com.alibaba.dubbo.remoting.transport.netty.Netty4Transporter;
...
public class ClientsTest {
    ...
    public void testGetTransport3() {
        String name = "netty4";
        assertEquals(Netty4Transporter.class, ExtensionLoader.getExtensionLoader(Transporter.class).getExtension(name).getClass());
    }
