...
import com.alibaba.dubbo.remoting.transport.netty.Netty4Client;
import com.alibaba.dubbo.remoting.transport.netty.Netty4Server;
...
public class ThreadNameTest {
    ...
    public void before() throws Exception {
        ...
        server = new Netty4Server(serverURL, serverHandler);
        client = new Netty4Client(clientURL, clientHandler);
    }
