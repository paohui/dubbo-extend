...
public class NettyClientTest {
    ...
    public static void setUp() throws Exception {
        server = Exchangers.bind(URL.valueOf("exchange://localhost:10001?server=netty4"), new TelnetServerHandler());
    }
    ...
    public void testClientClose() throws Exception {
        ...
        for (int i = 0; i < 100; i++) {
            ExchangeChannel client = Exchangers.connect(URL.valueOf("exchange://localhost:10001?client=netty4"));
            Thread.sleep(5);
            clients.add(client);
        }
